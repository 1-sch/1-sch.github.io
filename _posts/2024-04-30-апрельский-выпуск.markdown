...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/1.jpg" onclick="openModal();currentSlide(1)">
  </div>

  <div class="gal1" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/2.jpg" onclick="openModal();currentSlide(2)">
  </div>

  <div class="gal1" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/3.jpg" onclick="openModal();currentSlide(3)">
  </div>
    <div class="gal1" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/4.jpg" onclick="openModal();currentSlide(4)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">5</div>
   <img src="/img/0424/5.jpg" onclick="openModal();currentSlide(5)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">6</div>
   <img src="/img/0424/6.jpg" onclick="openModal();currentSlide(6)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">7</div>
   <img src="/img/0424/7.jpg" onclick="openModal();currentSlide(7)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">8</div>
   <img src="/img/0424/8.jpg" onclick="openModal();currentSlide(8)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/9.jpg" onclick="openModal();currentSlide(1)">
  </div>

  <div class="gal2" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/13.jpg" onclick="openModal();currentSlide(2)">
  </div>

  <div class="gal2" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/11.jpg" onclick="openModal();currentSlide(3)">
  </div>
    <div class="gal2" id="gb">
    <div class="numbertext">4</div>
 <img src="/img/0424/12.jpg" onclick="openModal();currentSlide(4)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">5</div>
   <img src="/img/0424/10.jpg" onclick="openModal();currentSlide(5)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">6</div>
   <img src="/img/0424/14.jpg" onclick="openModal();currentSlide(6)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">7</div>
   <img src="/img/0424/15.jpg" onclick="openModal();currentSlide(7)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">8</div>
   <img src="/img/0424/16.jpg" onclick="openModal();currentSlide(8)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">9</div>
   <img src="/img/0424/17.jpg" onclick="openModal();currentSlide(9)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/18.jpg" onclick="openModal();currentSlide(1)">
  </div>

  <div class="gal3" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/19.jpg" onclick="openModal();currentSlide(2)">
  </div>

  <div class="gal3" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/20.jpg" onclick="openModal();currentSlide(3)">
  </div>
    <div class="gal3" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/21.jpg" onclick="openModal();currentSlide(4)">
  </div>
