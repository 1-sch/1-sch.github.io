...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/1.jpg" onclick="om(1);currentSlide(1)">
  </div>

  <div class="gal1" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/2.jpg" onclick="om(1);currentSlide(2)">
  </div>

  <div class="gal1" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/3.jpg" onclick="om(1);currentSlide(3)">
  </div>
    <div class="gal1" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/4.jpg" onclick="om(1);currentSlide(4)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">5</div>
   <img src="/img/0424/5.jpg" onclick="om(1);currentSlide(5)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">6</div>
   <img src="/img/0424/6.jpg" onclick="om(1);currentSlide(6)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">7</div>
   <img src="/img/0424/7.jpg" onclick="om(1);currentSlide(7)">
  </div>
  <div class="gal1" id="gb">
  <div class="numbertext">8</div>
   <img src="/img/0424/8.jpg" onclick="om(1);currentSlide(8)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/9.jpg" onclick="om(2);currentSlide(1)">
  </div>

  <div class="gal2" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/13.jpg" onclick="om(2);currentSlide(2)">
  </div>

  <div class="gal2" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/11.jpg" onclick="om(2);currentSlide(3)">
  </div>
    <div class="gal2" id="gb">
    <div class="numbertext">4</div>
 <img src="/img/0424/12.jpg" onclick="om(2);currentSlide(4)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">5</div>
   <img src="/img/0424/10.jpg" onclick="om(2);currentSlide(5)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">6</div>
   <img src="/img/0424/14.jpg" onclick="om(2);currentSlide(6)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">7</div>
   <img src="/img/0424/15.jpg" onclick="om(2);currentSlide(7)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">8</div>
   <img src="/img/0424/16.jpg" onclick="om(2);currentSlide(8)">
  </div>
  <div class="gal2" id="gb">
  <div class="numbertext">9</div>
   <img src="/img/0424/17.jpg" onclick="om(2);currentSlide(9)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/18.jpg" onclick="om(3);currentSlide(1)">
  </div>

  <div class="gal3" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/19.jpg" onclick="om(3);currentSlide(2)">
  </div>

  <div class="gal3" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/20.jpg" onclick="om(3);currentSlide(3)">
  </div>
    <div class="gal3" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/21.jpg" onclick="om(3);currentSlide(4)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/22.jpg" onclick="om(4);currentSlide(1)">
  </div>

  <div class="gal4" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/23.jpg" onclick="om(4);currentSlide(2)">
  </div>

  <div class="gal4" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/24.jpg" onclick="om(4);currentSlide(3)">
  </div>
    <div class="gal4" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/25.jpg" onclick="om(4);currentSlide(4)">
  </div>
    <div class="gal4" id="gb">
  <div class="numbertext">5</div>
    <img src="/img/0424/26.jpg" onclick="om(4);currentSlide(1)">
  </div>

  <div class="gal4" id="gb">
  <div class="numbertext">6</div>
    <img src="/img/0424/27.jpg" onclick="om(4);currentSlide(2)">
  </div>

  <div class="gal4" id="gb">
  <div class="numbertext">7</div>
    <img src="/img/0424/28.jpg" onclick="om(4);currentSlide(3)">
  </div>
    <div class="gal4" id="gb">
    <div class="numbertext">8</div>
  <img src="/img/0424/29.jpg" onclick="om(4);currentSlide(4)">
  </div>
    <div class="gal4" id="gb">
  <div class="numbertext">9</div>
    <img src="/img/0424/30.jpg" onclick="om(4);currentSlide(1)">
  </div>
    <div class="gal4" id="gb">
  <div class="numbertext">10</div>
    <img src="/img/0424/31.jpg" onclick="om(4);currentSlide(1)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/32.jpg" onclick="om(5);currentSlide(1)">
  </div>

  <div class="gal5" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/33.jpg" onclick="om(5);currentSlide(2)">
  </div>

  <div class="gal5" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/34.jpg" onclick="om(5);currentSlide(3)">
  </div>
    <div class="gal5" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/35.jpg" onclick="om(5);currentSlide(4)">
  </div>
    <div class="gal5" id="gb">
  <div class="numbertext">5</div>
    <img src="/img/0424/36.jpg" onclick="om(5);currentSlide(1)">
  </div>

  <div class="gal5" id="gb">
  <div class="numbertext">6</div>
    <img src="/img/0424/37.jpg" onclick="om(5);currentSlide(2)">
  </div>

  <div class="gal5" id="gb">
  <div class="numbertext">7</div>
    <img src="/img/0424/38.jpg" onclick="om(5);currentSlide(3)">
  </div>
    <div class="gal5" id="gb">
    <div class="numbertext">8</div>
  <img src="/img/0424/39.jpg" onclick="om(5);currentSlide(4)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/40.jpg" onclick="om(6);currentSlide(1)">
  </div>

  <div class="gal6" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/41.jpg" onclick="om(6);currentSlide(2)">
  </div>

  <div class="gal6" id="gb">
  <div class="numbertext">3</div>
    <img src="/img/0424/42.jpg" onclick="om(6);currentSlide(3)">
  </div>
    <div class="gal6" id="gb">
    <div class="numbertext">4</div>
  <img src="/img/0424/43.jpg" onclick="om(6);currentSlide(4)">
  </div>
...
<div class="slideshow-container">
  ...
  <div class="numbertext">1</div>
    <img src="/img/0424/44.jpg" onclick="om(7);currentSlide(1)">
  </div>

  <div class="gal7" id="gb">
  <div class="numbertext">2</div>
    <img src="/img/0424/45.jpg" onclick="om(7);currentSlide(2)">
  </div>
